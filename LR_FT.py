...
# Vectorization
vectorizer = TfidfVectorizer(max_features=2760)
...
def evaluate_lr_on_folds(n_folds=10):
    accuracies = []
    recalls = []
    roc_aucs = []
    f1_scores = []
    ...
    for fold in range(1, n_folds + 1):
        ...
        model = LogisticRegression(max_iter=1000, class_weight='balanced', penalty='l2', solver='saga', C=30)
...
# Run the evaluation
evaluate_lr_on_folds(n_folds=10)
